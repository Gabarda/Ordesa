...
lyr_Vegetacion_2.set('fieldAliases', {'Especie_Dominante': 'Especie_Dominante', });
lyr_Vegetacion_2.set('fieldImages', {'Especie_Dominante': '', });
lyr_Vegetacion_2.set('fieldLabels', {'Especie_Dominante': 'header label', });
